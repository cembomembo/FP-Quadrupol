...
Test gases are supplied from dedicated gas reservoirs connected to the recipient via a dosing manifold.  
Each gas line contains shut-off valves and a fine control (needle) valve for metering the gas flow into the chamber.  
During dosing, the needle valve is opened gradually while pumping continues, so the pressure rises until inflow and pumping balance and a stable operating pressure is reached.  

\vspace{1em}
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\linewidth]{../resources/figures/schematic_setup.png}
...
Two external DC power supplies feed a voltage divider, which provides the required DC voltages for the control unit and for the QMS head.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\linewidth]{../resources/figures/schematic_ion_energy.png}
