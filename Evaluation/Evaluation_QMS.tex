...
The values from Table~\ref{tab:fwhm_results} were then plotted, along with the respective working lines for each spectrum (Figure~). For the linear analysis and plot, the argon peaks at 40Th were removed, since their intensity was too weak in our measurements and their FWHM was very hard to measure; we deemed its signal-to-noise ratio too high.
...
\begin{figure}
  ...
  \caption{Comparison of different mass resolution trends. Lower resolutions exhibit a much higher slope in the ratio, while very high resolutions exhibit an almost constant relationship.}
\end{figure}
