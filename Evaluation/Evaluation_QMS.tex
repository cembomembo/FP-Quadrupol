...
\begin{figure}[H]
  ...
  \caption{Comparision of different $U_{FA}$ voltages for the air spectrum measurement at normalized pressure. The effect of the electron acceleration in the signal is clearly visible.}\label{fig:acceleration}
\end{figure}
...
\subsection{Spectra}
Hey one very important thing is to please
...
also comment that the measurement in H2O(18) is not very precise in low res bc it mixes with the peaks of O+(16) and OH+ (17)
