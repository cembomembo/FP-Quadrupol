...
Task 5: discuss the qualitative trade-off (peak narrowing vs signal loss). Please indicate that the H2O has also the O2 subpeaks and that theres some error on it
