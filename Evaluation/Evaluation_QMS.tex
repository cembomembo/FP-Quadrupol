...
Figure~\ref{fig:acetone} contains the acetone spectrum in the range of 10 to 60 $m/z$, with normalized pressure. Both the dominant peaks (blue) and the fragment peaks (green) were labelled. The comparison to the reference spectrum confirms the expected peaks found in our data (Figure~\ref{fig:argon-reference}).

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\linewidth]{../resources/task_5_2_acetone.png}
  \caption{Corrected Argon spectrum, background spectrum, and recorded background spectrum. The intensities were normalized according to their respective pressure values and the spectrums were matched using the $H_2O^+$ peak as reference.}\label{fig:acetone}
\end{figure}

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\linewidth]{../resources/figures/QMS_Beispiel-Spektren/QMS_Beispiel-Spektren-3.png}
...
Task 2 to 4: Compare to the references spectrums and discuss unexpected peaks or overlaps (e.g. air/water background, argon remnants)
