...
The mass-to-charge spectrum of air was analyzed using five different resolution settings. An overlay of the five spectrums is shown in Figure~\ref{fig:resolution}. Higher resolution measurements exhibit much narrower and smaller intensity peaks than measurements with lower resolution settings. Quantitatively we can compare the Resolving Power and peaks width of each measurement, as shown in Table~\ref{tab:fwhm_results}.
