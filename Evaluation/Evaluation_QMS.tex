...
The resolution also alters when the acceleration voltage in changed. This can be seen in \ref{fig:acceleration}. For low acceleration volotages the Ions have not enough momentum to make it through the spectrometer. This can be seen for the $U_{B} = 0.2$ measurment where hardly any Ions are detected, because 
