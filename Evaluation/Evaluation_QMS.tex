...
Hey one very important thing is to please also comment that the measurement in H2O(18) is not very precise in low res bc it mixes with the peaks of O+(16) and OH+ (17)

- broadening of the peaks with lower resolution/working line
- but also higher peaks, this is expected.
- also shifted to the right for lower resolutionss

- the lower the resolution the bigger the slope of

- for higher acceleration voltage bands also broaden, but in a different way, the peaks the peaks remain pointed, but broaden due to more ions making it through the spectrometer
